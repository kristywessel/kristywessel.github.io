//#region node_modules/.nitro/vite/services/ssr/assets/projects-gzi2ml8X.js
var projects = [
	{
		slug: "jamf-pro-11",
		title: "Jamf Pro 11",
		...
		summary: "Drove front end deliverables and outcomes for the Jamf Pro 11 release — including the highly praised Dark Mode — delivered on time, on budget, and on target.",
		description: [
		...
		image: "/assets/jpro11-BWpgydv0.jpg"
	},
	{
		slug: "neuro-allies",
		title: "Neuro Allies",
		...
		summary: "Everything from purchasing the domain and configuring DNS to hosting, WordPress setup, and ongoing management. Mobile-first.",
		description: [
		...
		link: {
			label: "Visit neuro-allies.com",
			href: "https://neuro-allies.com"
		},
		image: "/assets/neuro-allies-BN63Y6RE.png",
		modalImage: "/assets/neuro-allies-BN63Y6RE.png"
	},
	{
		...
		year: "2024",
		category: "Web Development",
		summary: "Full-stack ownership from domain purchase through hosting, WordPress setup, and mobile-first design.",
		description: [
		...
		link: {
			label: "Visit brighterdayfarms.com",
			href: "https://brighterdayfarms.com/"
		},
		image: "/assets/brighterdayfarms-C5I31KS9.png",
		modalImage: "/assets/brighterdayfarms-C5I31KS9.png"
	},
	{
		slug: "write-to-heal",
		title: "Write to Heal",
		...
		year: "2024 – present",
		category: "Web Development",
		summary: "A WordPress-based digital experience focused on journaling and emotional well-being. Founded, built, and maintained end-to-end.",
		description: [
		...
		link: {
			label: "Visit thewritetoheal.com",
			href: "https://thewritetoheal.com/"
		},
		image: "/assets/writetoheal-Cw3oILLm.png",
		modalImage: "/assets/writetoheal-Cw3oILLm.png"
	},
	{
		slug: "target-canada",
		title: "Target Canada",
		...
		year: "2012 – 2013",
		category: "Web Development",
		summary: "Hired onto Target's in-house creative team to help build the Canadian retail website — a massive from-scratch undertaking.",
		description: [
		...
		image: "/assets/target-ca-iJ4pVKZW.png",
		modalImage: "/assets/m-target-ca-CGXWOGQ_.png"
	},
	{
		...
		year: "2016 – 2018",
		category: "Web Development",
		summary: "A platform for anyone consuming Thomson Reuters APIs. Established front end standards, implementation patterns, and governance.",
		description: [
		...
		image: "/assets/tr-dev-portal-rgK2EwYb.png",
		modalImage: "/assets/m-tr-dev-portal-DbMbu9fO.png"
	},
	{
		...
		year: "2020",
		category: "Leadership",
		summary: "Used CARES Act funding to expand internet access for library patrons — 500+ kits with 4G hotspots and Chromebooks still serving thousands of patrons every year.",
		description: [
		...
		image: "/assets/washcolib-chromebook-e6Hgynmb.jpeg",
		modalImage: "/assets/m-washcolib-hotspot-CYXRUwQT.jpeg",
		extraLinks: [{
			label: "Device information",
			href: "https://www.washcolib.org"
		}, {
			label: "KSTP news coverage",
			href: "https://kstp.com"
		}]
	},
	{
		...
		year: "2016",
		category: "Teaching",
		summary: "Prepared a student team at Prime Digital Academy to build a from-scratch reservation app for Minnesota's first arts-based public benefit corporation.",
		description: [
		...
		image: "/assets/can-can-wGkg2YW6.png",
		modalImage: "/assets/m-can-can-CuQDzwf7.png"
	},
	{
		slug: "walker-west",
		...
		year: "2014",
		category: "Web Development",
		summary: "Built the website for a St. Paul music school teaching students ages 5 through adult. Worked closely with the team to reflect their vision and strategy.",
		description: [
		...
		image: "/assets/walker-west-BWlixxQx.png",
		modalImage: "/assets/m-walker-west-Cze-Mr6P.png"
	},
	{
		slug: "cmrs",
		title: "CMRS",
		...
		year: "2014",
		category: "Web Development",
		summary: "A front end engineering project building a responsive web application.",
		description: [
			"Implemented responsive design and front end architecture.",
			"Collaborated with design and backend teams to deliver a seamless user experience.",
		...
		image: "/assets/CMRS-Boo2otuf.png",
		modalImage: "/assets/m-CMRS-CJxp_Kxh.png"
	}
];
